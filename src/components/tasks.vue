<template>
  <div class="hello">
    <div class="holder">
      ...
      <input type="text" placeholder="Enter your task for today" v-model="task" v-validate="'min:5'" name="task"> <!-- Adding the task inside a form -->
